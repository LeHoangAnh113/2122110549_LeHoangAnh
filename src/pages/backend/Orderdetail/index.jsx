...
const Orderdetail = () => {
  const orderdetail = Database.orderdetails; // Sử dụng 'orderdetail' từ đối tượng JSON
                ...
                {orderdetail && orderdetail.length > 0 ? (
                  orderdetail.map(orderdetail => (
                    <tr key={orderdetail.id}>
                      ...
                      <td>{orderdetail.link}</td>
                      <td>{orderdetail.position}</td>
                      <td className='text-center'>
                        <Link className='btn btn-sm btn-info me-1' to={`/admin/orderdetail/edit/${orderdetail.id}`}><FaEdit /></Link>
